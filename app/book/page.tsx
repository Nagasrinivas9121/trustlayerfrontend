    ...
    <div className="bg-background min-h-screen pt-24 pb-20">
      <div className="section-container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <h1 className="heading-2 mb-4 font-sans text-textPrimary">
            Schedule a 30-Minute <span className="text-primary">Security Review</span>
          </h1>
          <p className="body-text text-textSecondary font-sans text-base max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-surface border border-border/80 rounded-2xl p-6 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-xs font-sans">
              <a
                ...
                className="flex items-center justify-center gap-2 p-3 bg-surface border border-border/80 rounded-xl hover:border-zinc-400 transition-colors text-textPrimary font-medium"
              >
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 p-3 bg-surface border border-border/80 rounded-xl hover:border-emerald-500/40 transition-colors text-textPrimary font-medium"
              >
