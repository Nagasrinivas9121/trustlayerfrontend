...
export const metadata: Metadata = {
  ...
  description:
    "Meet the founder of TrustLayerLabs — Nagasrinivasa Rao, an OSCP, CEH & eWPT certified offensive security professional with 2+ years auditing enterprise APIs, cloud architectures, and financial systems.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Nagasrinivasa Rao — OSCP, CEH & eWPT certified. 2+ years securing APIs, cloud infrastructure, and financial systems for enterprise clients.",
