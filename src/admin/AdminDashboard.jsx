...
import { Trash2, Plus, Users, BookOpen, Briefcase, ExternalLink, Activity, Percent } from "lucide-react";
            ...
            <section className="bg-gray-900/40 backdrop-blur-xl p-8 rounded-[2rem] border border-white/5 shadow-2xl shadow-black">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10 bg-black/40 p-8 rounded-3xl border border-white/5">
                ...
                <div className="space-y-2 md:col-span-2">
                   ...
                   <div className="flex gap-4">
                    ...
                    <button onClick={addCourse} className="bg-white text-black px-8 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-accent hover:text-white transition-all shadow-lg">
                      Deploy_Module
                    </button>
                   </div>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {courses.map(c => {
                  ...
                  return (
                    <motion.div layout key={c.id} className="p-6 bg-white/5 rounded-3xl border border-white/5 group hover:border-accent/50 transition-all relative overflow-hidden">
